...
import { Shield, Code2, Heart, ArrowLeft, Sparkles, GraduationCap } from 'lucide-react';

export default function AboutPage() {
    const router = useRouter();

    return (
        <div style={{ maxWidth: 900, margin: '0 auto', color: 'white', padding: '40px 20px 80px 20px', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            
            {/* Back Button */}
            <div style={{ width: '100%', display: 'flex', justifyContent: 'flex-start', marginBottom: 20 }}>
                <button 
                    onClick={() => router.back()}
                    style={{ background: 'rgba(255,255,255,0.05)', color: 'rgba(255,255,255,0.6)', border: '1px solid rgba(255,255,255,0.1)', padding: '6px 16px', borderRadius: 20, display: 'flex', alignItems: 'center', gap: 6, cursor: 'pointer', fontSize: 13 }}
                >
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: 64 }}>
                ...
                <h1 style={{ fontSize: 42, fontWeight: 800, margin: '0 0 8px 0', letterSpacing: -0.5 }}>CampusNiti</h1>
            ...
            <div style={{ 
                ...
                <div style={{ display: 'flex', gap: 24, alignItems: 'flex-start' }}>
                    ...
                    <div>
                        ...
                        <p style={{ color: 'rgba(255,255,255,0.6)', fontSize: 13, lineHeight: 1.6, margin: '0 0 16px 0', maxWidth: 600 }}>
                            Conceived, designed, and led the development of CampusNiti from the ground up — architecting the full-stack infrastructure, database schema, and all core features.
                        </p>
            ...
            <div style={{ textAlign: 'center', color: 'rgba(255,255,255,0.3)', fontSize: 12 }}>
                ...
                <div>© 2026 CampusNiti · All Rights Reserved</div>
            </div>
        </div>
    );
}
